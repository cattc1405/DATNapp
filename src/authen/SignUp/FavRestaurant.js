        ...
        <View style={styles.iconsContainer}>
          ...
          <View style={styles.row}>
            ...
            <TouchableOpacity
              ...
              <Image
                source={require('../../../assets/images/Domino.png')}
                style={styles.icon}
              />
            </TouchableOpacity>
            <TouchableOpacity
          ...
          <View style={styles.row}>
            <TouchableOpacity
              ...
              <Image
                source={require('../../../assets/images/Wendy.png')}
                style={styles.icon}
              />
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Image
                source={require('../../../assets/images/Buffallo.png')}
                style={styles.icon}
              />
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Image
                source={require('../../../assets/images/Arby.png')}
                style={styles.icon}
              />
            </TouchableOpacity>
            <TouchableOpacity
